...
`shakilabs-ui-0.3.22.tgz` is the active exact artifact for `@shakilabs/ui` 0.3.22.

- Source repository: `kosmosbrewing/00.root-shakilabs`
- Source commit: `4849380d9b57c298ea3169b5f2997d283b1a24ae`
- SHA-256: `5c97c889289990e7ae7af490c9c97d3ac15a64abdf3542152bd8cd0ae8587bd8`
- Consumed by: `client/package.json` → `"@shakilabs/ui": "file:vendor/shakilabs-ui-0.3.22.tgz"`
...
```sh
shasum -a 256 client/vendor/shakilabs-ui-0.3.22.tgz   # 위 SHA-256과 일치해야 한다
