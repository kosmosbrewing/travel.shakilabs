...
<template>
  <Card class="overflow-hidden border-border/60 shadow-sm">
    <CardContent class="p-0">
      <section class="relative overflow-hidden bg-gradient-to-br from-primary/15 via-background to-primary/5">
      ...
      <section class="border-t border-border/60 bg-card/70 p-5 sm:p-6">
